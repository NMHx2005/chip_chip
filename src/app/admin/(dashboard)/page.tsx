    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-wrap gap-3">
        <Link
          ...
          className="inline-flex h-11 items-center gap-2 rounded-xl bg-primary px-5 text-sm font-semibold text-white transition-colors hover:bg-black/80"
        >
          Viết bài mới
        ...
        <Link
          href="/admin/bai-viet"
          className="inline-flex h-11 items-center rounded-xl border border-border px-5 text-sm font-medium text-text-nav transition-colors hover:border-black/20 hover:text-accent"
        >
          Xem tất cả bài viết
        </Link>
      </div>
